...
use App\LINE\LINEBot\Event\Parser\EventRequestParser;
use App\LINE\LINEBot\HTTPClient;
use App\LINE\LINEBot\MessageBuilder;
use App\LINE\LINEBot\MessageBuilder\TextMessageBuilder;
use App\LINE\LINEBot\Response;
use App\LINE\LINEBot\SignatureValidator;
use App\LINE\LINEBot\HTTPClient\CurlHTTPClient;
use ReflectionClass;
...
class LINEBot
{
...

    {
        ...
        $this->channelToken = getenv('LINEBOT_CHANNEL_TOKEN') ?: '';

        $this->httpClient = new CurlHTTPClient($this->channelToken);
        $this->channelSecret = ['channelSecret' => $this->channelSecret];
    ...
    {
        $messageBuilder = new \App\LINE\LINEBot\MessageBuilder\TextMessageBuilder($message);
